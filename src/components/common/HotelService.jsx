            ...
            <Container className="mb-2">
                ...
                <Row>
                    <h4 className="text-center">
                        Services at <span className="hotel-color">Booking-</span>Hotel <span className="gap-2">
                    ...
                    <Col>
                        <Card>
                            <Card.Body>
                                ...
                                <Card.Text>Keep your clothes clean and fresh with ouer laundry service.</Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                    ...
                    <Col>
                        <Card>
                            <Card.Body>
                                ...
                                <Card.Text>Park your car converniently in our on-site parking lot.</Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
