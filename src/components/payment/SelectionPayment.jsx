...
export const SelectionPayment = ({ paymentMethod, setPaymentMethod, cardInfo, setCardInfo, isProcessing, handlePay }) => {
            ...
            <form onSubmit={handlePay}>
                <div className="row g-3 g-lg-4">
                    <div className="col-12 col-lg-7">
                        ...
                        <div
                            className={`border rounded-3 p-3 mb-2.5 cursor-pointer transition-all ${paymentMethod === 'vietqr' ? 'border-primary bg-primary-subtle bg-opacity-25 shadow-sm' : 'bg-white'
                                }`}
                        ...
                        {/* Option 2: Ví MoMo */}
                        <div
                            className={`border rounded-3 p-3 mb-2.5 cursor-pointer transition-all ${paymentMethod === 'momo' ? 'border-primary bg-primary-subtle bg-opacity-25 shadow-sm' : 'bg-white'
                                }`}
                        ...
                        <div
                            className={`border rounded-3 p-3 mb-2.5 cursor-pointer transition-all ${paymentMethod === 'card' ? 'border-primary bg-primary-subtle bg-opacity-25 shadow-sm' : 'bg-white'
                                }`}
                    ...
                    <div className="col-12 col-lg-5">
                        ...
                        <div
                            className={`border rounded-3 p-3 cursor-pointer transition-all ${paymentMethod === 'paylater' ? 'border-primary bg-primary-subtle bg-opacity-25 shadow-sm' : 'bg-white'
                                }`}
